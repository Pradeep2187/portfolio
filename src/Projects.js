...
const Projects = () => {
  ...
  const handleGithubClick = () => {
    window.open('https://github.com/VenkataSaiPradeep/', '_blank');
  };

  // Function to handle button click for Medium
  const handleMediumClick = () => {
    window.open('https://medium.com/@nvspradeep5', '_blank');
  };
...
<a className="external" href="https://github.com/VenkataSaiPradeep/Heart-Disease-Prediction-Using-Machine-Learning" target="_blank" rel="noopener noreferrer">
    <FaGithub size={20} className="icon" />
      ...
      <br></br>
      <br></br>
      <button className="download-button" onClick={handleGithubClick}>
        <FaGithub /> &nbsp;Other Projects
      </button>
      <br></br>
      <button className="download-button" onClick={handleMediumClick}>
